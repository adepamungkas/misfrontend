...
class ReportMaterial extends Component {
    ...
    render() {
        ...
        const fields = ['ID', 'Date', 'Description', 'Name', 'Color', 'Size', 'Trademark', 'Vendor', 'Type']
            ...
            <>
              ...
              <small> Material</small>
                            ...
                            <CCardFooter>
                                ...
                                <CButton type="reset" size="sm" color="warning" onClick={() => this.reset()} > Reset</CButton>
                                <CButton type="submit" size="sm" color="primary" onClick={() => this.search()}> Cari</CButton>
                                <CButton type="submit" size="sm" color="success">Export to Excel</CButton>
